...
$ npm install @bryntum/calendar-angular@5.3.6
```
...
```shell
$ yarn add @bryntum/calendar@npm:@bryntum/calendar-trial@5.3.6
$ yarn add @bryntum/calendar-angular@5.3.6
```
...
"dependencies": {
  ...
  "@bryntum/calendar-angular": "5.3.6"
}
```
...
```shell
$ yarn add @bryntum/calendar@5.3.6
$ yarn add @bryntum/calendar-angular@5.3.6
```
...
"dependencies": {
  ...
  "@bryntum/calendar": "file:./lib/bryntum-calendar-trial-5.3.6.tgz"
}
```
...
"dependencies": {
  ...
  "@bryntum/calendar": "file:./lib/bryntum-calendar-5.3.6.tgz"
}
```
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/calendar@5.3.6’ is not in the npm registry.
```
