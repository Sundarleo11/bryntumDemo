...
import { AlignSpec, Base, ContainerItemConfig, ContainerLayoutConfig, Layout, MaskConfig, Model, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceFilter, ResourceFilterConfig, Scroller, ScrollerConfig, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export declare class BryntumSidebarComponent implements OnInit, OnDestroy {
    ...
    readOnly: boolean;
    record: Model;
    resourceFilter: ResourceFilter | Partial<ResourceFilterConfig>;
