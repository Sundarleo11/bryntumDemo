const examples = {
    ...
    'Power demos' : {
        items : [
            ...
            { folder : 'dragfromgrid', title : 'Drag events from external grid', since : '4.0.4' },
    ...
    Integration : {
        items : [
            ...
            { folder : 'salesforce', title : 'Using Calendar as Lightning Web Component', offline : true, since : '4.0.3' },
